...
import { Coins, Zap, Trash2, History, Undo2, ChevronDown, ChevronUp } from 'lucide-react';
...
const TaskList = ({ tasks, loading, onTaskComplete, onTaskDelete, onTaskUncomplete }) => {
  const { token } = useAuth();
